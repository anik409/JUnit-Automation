...
public class MyJUnit {
    ...
    void registerNewUser() {
        ...
        driver.findElement(By.name("first_name")).sendKeys("Abu");
        driver.findElement(By.name("last_name")).sendKeys("Sayeed");
        driver.findElement(By.name("user_email")).sendKeys("abusayeed167@gmail.com");
        driver.findElement(By.name("user_pass")).sendKeys("36@July2024");
